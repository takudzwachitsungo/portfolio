        ...
        <div className="grid md:grid-cols-5 gap-10">
          <div className="md:col-span-3">
            <div className="space-y-4 text-[#8892b0]">
              <p className="text-lg">
                I'm a final-year Business Studies and Computer Science student with a strong focus on 
                building innovative software solutions. My expertise spans across <span className="text-[#64ffda]">web development</span>,{' '}
